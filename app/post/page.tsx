      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        >
          ...
          <div>
            ...
            <div className="mt-1 flex gap-2">
              <input
                type="url"
                required
                className={`flex-1 rounded border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 ${placeholderClass} focus:border-[#001e43] focus:outline-none focus:ring-1 focus:ring-[#001e43]`}
          ...
          <div>
            ...
            <input
              type="text"
              className={`mt-1 w-full rounded border border-slate-300 bg-slate-50 px-3 py-2 text-sm text-slate-900 ${placeholderClass} cursor-not-allowed`}
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <div className="mt-1 flex items-center gap-1">
                <input
                  type="number"
                  className={`w-full rounded border border-slate-300 bg-slate-50 px-3 py-2 text-sm text-slate-900 ${placeholderClass} cursor-not-allowed`}
                  placeholder="楽天から自動入力されます"
                  value={price}
                  readOnly
                  disabled
          ...
          <div>
            ...
            />
            <p className="mt-1 text-xs text-slate-600">
              楽天APIから生成されたリンクが自動で入ります。編集はできません。
            </p>
          </div>
          ...
          <div>
            ...
            <textarea
              required
              className={`mt-1 w-full rounded border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 ${placeholderClass} focus:border-[#001e43] focus:outline-none focus:ring-1 focus:ring-[#001e43]`}
              rows={4}
